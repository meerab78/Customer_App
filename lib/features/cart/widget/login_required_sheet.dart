...
import '../../../core/theme/fonts_manager.dart';
import '../../../core/theme/textfont_styles.dart';
import '../../base/controller.dart'; // CHANGED path
import '../../home/widget/delivery_pickup_card.dart';
import '../checkout_view.dart';
import '../controller.dart';
            ...
            children: [
              ...
              DeliveryPickupCard(
                ...
                onTap: () {
                  ...
                  // CHANGED: naya screen stack nahi — BaseView ka
                  // Profile tab (index 3) select karo, jo guest hone
                  // par khud SignInView dikha deta hai
                  context.read<BaseTabController>().changeTab(3);
              ...
              // GUEST OPTION (bilkul same, koi change nahi)
              DeliveryPickupCard(
                icon: Icons.person_outline_rounded,
                title: "Continue as Guest",
                subtitle: "Checkout without creating an account",
